...
// Exercise Summary:
//
// The following exercise will explore how we can utilize a `Request` cache to
// cache the results of our requests. We will re-use our Pokemon API code for
// this example.
//
// Your goal will be to enable request caching on the `PokemonRepo.getById`
// method and then set the request cache to a custom request cache with:
//   - A `capacity` of `250`
